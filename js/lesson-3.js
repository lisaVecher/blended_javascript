...
// const evenNumbers = numbers.every((item) => item % 2 === 0);
...
// const oddNumber = numbers.find((item) => item % 2 !== 0);
...
// const letterArray = stringArray.toSorted((a, b) => a.localeCompare(b));
...
// const ascendingAge = users.toSorted((a, b) => a.age - b.age);
...
// const ageMore = user.filter((item) => item.age > 20);
